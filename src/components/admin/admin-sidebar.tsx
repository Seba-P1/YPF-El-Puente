...
import { Package, Tags, Settings, Activity, Fuel, History, LogOut, LayoutDashboard, LayoutTemplate, DollarSign, Instagram } from 'lucide-react'
...
const navMain = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Actualizar Precios', url: '/admin/precios', icon: DollarSign },
