...
export function MobileBottomBar() {
  ...
  return (
    <nav
      className="md:hidden fixed bottom-0 left-0 right-0 z-50 w-full max-w-[100vw] overflow-x-hidden"
      style={{
    ...
    >
      <div className="flex items-center justify-around h-16 px-1 w-full max-w-[100vw]">
        <Link
          href="/"
        ...
        <Link
          href="/full"
          className="flex flex-col items-center justify-center flex-1 min-w-0 h-full space-y-1"
          style={{ color: isActive('/full', true) && !isActive('/full/menu') ? '#FFD100' : 'rgba(248,250,252,0.45)' }}
        >
